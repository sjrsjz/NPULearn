import { AppEvents, chatContent, chatHistory, isLoading, isStreaming } from "./eventBus";
...
async function createNewChat() {
    ...
    try {
        ...
        // 更新聊天内容显示
        AppEvents.updateChatContent(chatContent.value);
        // 重新加载历史记录以显示新创建的对话
...
async function loadChatHistory() {
    try {
        ...
        AppEvents.updateChatContent(chatContent.value); // 确保在加载历史后更新内容
    } catch (error) {
